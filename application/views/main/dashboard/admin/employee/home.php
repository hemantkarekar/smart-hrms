<!-- All Employees Data : Access Level - Admin > HR -->
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline mb-2">
                        ...
                        <div class="dropdown mb-2">
                            <a class="btn btn-primary btn-icon-text" type="button" id="dropdownMenuButton7" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i data-feather="plus" class="icon-sm mb-1 btn-icon-prepend"></i>New Employee
                            </a>
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex gap-2">
                ...
                <button type="reset" class="btn btn-secondary" data-bs-dismiss="modal">Reset Details</button>
            </div>
        </div>
    </div>
</div>
